...
* **Propósito**: PWA para festival gastronómico con modal de bienvenida (Google / Invitado), base de datos de leads para marketing con exportación CSV, radar en vivo, agenda de espectáculos, stands con filtros dietarios (Vegano/Sin TACC), sorteo con Golden Ticket QR interactivo, mapa interactivo de Plaza Independencia (con Zona DJ) y panel de administración para operadores con acceso por PIN.
...
* **Test de Botones, Leads & UI (82 pruebas JSDOM):** `node test_all_app_buttons.js`
